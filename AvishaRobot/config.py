...
class Config(object):
    ...
    OWNER_USERNAME = ("OWNER_USERNAME", "queen143np")
    ...
    LOG_CHANNEL = getenv("LOG_CHANNEL", "-1002346882702")
    ...
    SPAMWATCH_SUPPORT_CHAT = getenv("SPAMWATCH_SUPPORT_CHAT", "BLOOD_MANSION")
